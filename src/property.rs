...
//!
//! The `property` module expose the basic structures that represent the `Properties` an Event
//! contains, based on its [`Schema`](crate::schema::Schema). These `Properties` can then be used to
//! parse accordingly their values.
